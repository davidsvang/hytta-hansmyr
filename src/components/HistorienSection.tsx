      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="relative">
          <div className="relative aspect-[3/4] rounded-sm overflow-hidden">
            <CabinImage
              src="/images/IMG_0183.jpeg"
              alt="Morfar på verandaen"
              fill
        ...
        <div>
          ...
          <div className="space-y-5 text-[#5F5E5A] font-lato font-light text-base leading-relaxed">
            ...
            <p>
              ...
              <span className="placeholder-amber">
                [NAVN — venter på mormor]
              </span>
              , og har siden den dag stått stille mens verden rundt har forandret
              seg.
            </p>

            <p>
              <span className="placeholder-amber">
                [ORIGINAL NAVN PÅ HYTTA — venter på mormor]
              </span>
            </p>
            ...
            <p>
              ...
              selvforsynt med dyr og jord. Tidligere eide familien Linstad
              eiendommen.
            </p>
            ...
            <p className="placeholder-amber">
              [MER INNHOLD KOMMER — venter på mormor]
            </p>
          </div>
