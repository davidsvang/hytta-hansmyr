    ...
    <section className="py-20 bg-[#F5F0E8]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {/* Blåbær */}
          <div className="bg-white rounded-sm border border-[#2C2A1E]/10 p-8">
            ...
            <dl className="space-y-3">
              <div className="flex gap-4">
                ...
                <dd className="text-[#2C2A1E] font-lato font-light text-sm">
                  Mid-juli til slutten av august
                </dd>
              </div>
              <div className="flex gap-4">
                <dt className="label-caps text-[#5F5E5A] w-20 flex-shrink-0">Lokasjon</dt>
                <dd className="text-[#2C2A1E] font-lato font-light text-sm">
                  Skogbunnen rundt hytta
                </dd>
              </div>
              <div className="flex gap-4">
                <dt className="label-caps text-[#5F5E5A] w-20 flex-shrink-0">Tips</dt>
                <dd className="text-[#2C2A1E] font-lato font-light text-sm">
                  Ta med en bøtte — her er det nok til alle!
                </dd>
              </div>
            </dl>
          </div>
          ...
          <div className="bg-white rounded-sm border border-[#2C2A1E]/10 p-8">
            ...
            <dl className="space-y-3">
              <div className="flex gap-4">
                <dt className="label-caps text-[#5F5E5A] w-20 flex-shrink-0">Sesong</dt>
                <dd className="text-[#2C2A1E] font-lato font-light text-sm">
                  Juli til første frost (høysesong august–oktober)
                </dd>
              </div>
              <div className="flex gap-4">
                <dt className="label-caps text-[#5F5E5A] w-20 flex-shrink-0">Typer</dt>
                <dd className="text-[#2C2A1E] font-lato font-light text-sm">
                  Kantarell, steinsopp, piggsopp
                </dd>
              </div>
              <div className="flex gap-4">
              ...
              <div className="flex gap-4">
                ...
                <dd className="text-[#2C2A1E] font-lato font-light text-sm">
                  &ldquo;Soppkontroll&rdquo; fra Norges sopp- og nyttevekstforbund
                </dd>
              </div>
            </dl>
          </div>
        ...
        {/* Soppguide placeholder */}
        <div className="bg-white rounded-sm border border-dashed border-[#8B5E3C]/40 p-8 mb-8">
          <p className="placeholder-amber font-lato text-sm">
            [SOPPGUIDE MED BILDER KOMMER — placeholder for kantarell, steinsopp, piggsopp]
          </p>
        </div>
